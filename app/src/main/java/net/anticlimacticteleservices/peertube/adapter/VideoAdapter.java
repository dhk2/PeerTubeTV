...
import net.anticlimacticteleservices.peertube.intents.Intents;
import net.anticlimacticteleservices.peertube.model.Avatar;
import net.anticlimacticteleservices.peertube.model.Video;

import java.util.ArrayList;

import static net.anticlimacticteleservices.peertube.activity.VideoListActivity.EXTRA_ACCOUNTDISPLAYNAME;
...
//        holder.videoDescription.setText(videoList.get(position).getDescription());
    ...
    class VideoViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView name, videoMeta, videoOwner, moreButton, videoDuration,videoDescription;
